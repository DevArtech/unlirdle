...
window.onload = function () {
    ...
    if (oV > 0) {
        one.children[0].style.width = Math.round(((oV / wins) * 100)).toString() + "%";
    ...
    if (twV > 0) {
        two.children[0].style.width = Math.round(((twV / wins) * 100)).toString() + "%";
    ...
    if (thV > 0) {
        three.children[0].style.width = Math.round(((thV / wins) * 100)).toString() + "%";
    ...
    if (foV > 0) {
        four.children[0].style.width = Math.round(((foV / wins) * 100)).toString() + "%";
    ...
    if (fiV > 0) {
        five.children[0].style.width = Math.round(((fiV / wins) * 100)).toString() + "%";
    ...
    if (sV > 0) {
        six.children[0].style.width = Math.round(((sV / wins) * 100)).toString() + "%";
...
function game_checker(gWord, uWord, green, yellow, gray) {
    ...
    if (acceptable_words.includes(player_word) || backup_gameWords.includes(player_word)) {
        if (uWord.length == 5) {
            ...
            warning('Not enough letters', 1000)
...
function keyboardUpdate(letters, value) {
    ...
    for (let i = 0; i < letters.length; i++) {
        ...
        if (value[i] === 2) {
            if (letterKey.classList.contains('invalid')) {
                letterKey.classList.remove('invalid');
            }
            if (letterKey.classList.contains('spot')) {
                letterKey.classList.remove('spot');
            }
            ...
            if (letterKey.classList.contains('correct') || letterKey.classList.contains('spot')) {
                return;
            }
            else {
...
let the_word = backup_gameWords[Math.floor(Math.random() * backup_gameWords.length)];
